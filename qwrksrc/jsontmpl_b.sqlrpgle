...
dcl-s jsonBuffer varchar(32000);
...
dcl-proc writeJsonFile;
   dcl-pi *n ind;
      ifspath varchar(80);
  //  jsonBuffer varchar(32000);                     //SGTST
      jsonBuffer varchar(32000) CCSID(*UTF8) value;  //SGTST
      replace char(1);
   end-pi;

   dcl-s fd int(10); // file descriptor
   dcl-s F_OK int(10) inz(0);
   dcl-C CCSID const(1208);   // 1208 is UTF-8
